...
const EditProfileModal = ({
  ...
  useEffect(() => {
    axios
      .get(`https://studybuddyvideocall.herokuapp.com/api/devs/${userId}`)
      .then((res) => {
  ...
  const onSubmit = (e) => {
    ...
    axios
      .put(
        `https://studybuddyvideocall.herokuapp.com/api/devs/${userId}`,
        userData
      )
      .then(() => {
  ...
  const selfDestroy = () => {
    ...
    axios
      .delete(`https://studybuddyvideocall.herokuapp.com/api/devs/${userId}`)
      .then(() => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center z-50 shadow-xl">
      <div className=" w-full md:w-3/4 xl:w-1/3 lg:w-2/3 shadow-xl flex flex-col p-1 sm:p-4 my-4 rounded-lg bg-white">
        <form onSubmit={onSubmit}>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-3">
              <div className="w-1/2">
                <label
                  className="text-sm sm:text-base font-normal text-gray-600"
                  for="firstName"
                >
                  First Name
                </label>
              ...
              <div className="flex justify-start gap-4">
                <div>
                  <input
                    ...
                    onChange={(e) =>
                      updateFields({ javaScript: e.target.checked })
                    }
                  />
          ...
          <div className="flex p-4 align-middle justify-center gap-2 md:gap-10">
            ...
            />
            <button
              className="rounded-md px-4 md:px-8 py-2 text-white border bg-black hover:bg-transparent hover:text-black hover:border-black"
              type="submit"
            >
              Save
            </button>
